# On-Chain AI Price Prediction Model on Solana
...
The model is deployed as compiled Python bytecode on Solana using a custom python on solana implimentation

**Deployment (once):**
1. Compile `nn_module.py` to custom python bytecode
...
The trick: The custom python can't call functions across modules, so the entire NN executes on `import`. Weird, but it works.

## A Solana Python Modification is Required
...
**Python on Solana is experimental:**
...
Copyright (c) 2026 SCLAY NZ

This source code and its associated documentation are proprietary and confidential. 
Unauthorized copying, modification, distribution, or performance of this software, 
via any medium, is strictly prohibited.

## Acknowledgments

- [xLSTM-TS](https://arxiv.org/abs/2408.12408) (arXiv:2408.12408)

---

*An experiment in on-chain machine learning by SCLAY NZ .*
